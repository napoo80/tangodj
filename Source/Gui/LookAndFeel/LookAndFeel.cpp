...
TangoDJLookAndFeel::TangoDJLookAndFeel()
{
}
...
/*void TangoDJLookAndFeel::drawButtonBackground (Graphics& g,
                                            Button& button,
...
//    const float indentB = button.isConnectedOnBottom() ? 0.1f : halfThickness;
    ...
    g.drawLine (2.0f, height - 0.5f, width - 2.0f, height - 0.5f, 0.5f);//    drawGlassLozenge (g,
//                      indentL,
//                      indentT,
